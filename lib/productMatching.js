...
export function mergeProductsAcrossPlatforms(zeptoProducts = [], blinkitProducts = [], jiomartProducts = [], dmartProducts = [], flipkartMinutesProducts = []) {
    const sources = [
    ...
    merged.sort((a, b) => {
        const countA = (a.zepto ? 1 : 0) + (a.blinkit ? 1 : 0) + (a.jiomart ? 1 : 0) + (a.dmart ? 1 : 0) + (a.flipkartMinutes ? 1 : 0);
        const countB = (b.zepto ? 1 : 0) + (b.blinkit ? 1 : 0) + (b.jiomart ? 1 : 0) + (b.dmart ? 1 : 0) + (b.flipkartMinutes ? 1 : 0);
